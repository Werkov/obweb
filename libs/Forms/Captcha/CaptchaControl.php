...
class CaptchaControl extends Nette\Forms\Controls\TextBase {
   ...
   public static function register() {
	 ...
	 self::$defaultFontFile = __DIR__ . "/fonts/Vera.ttf";
      ...
      Container::extensionMethod('addCaptcha', callback(__CLASS__, 'addCaptcha'));
    ...
    */
   public static function addCaptcha($form, $name) {
      $captcha = new static;
      
      $form[$captcha->getUidName() . $name] = new HiddenField($captcha->getUid());

      return $form[$name] = $captcha;
   }
