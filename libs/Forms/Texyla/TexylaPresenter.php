...
class TexylaPresenter extends BasePresenter {
    ...
    public function startup() {
        ...
        $this->tempDir = WWW_DIR . "/webcache";
        $this->tempUri = Environment::getVariable("baseUrl") . "/webcache";
    }
    ...
    public function actionPreview() {
        $html = $this->getTexy()->process(Environment::getHttpRequest()->getPost("texy"));
    ...
    private function getTexy(){
        if($this->getHttpRequest()->getPost('cfg') == 'texy'){
            return $this->getContext()->texy;
        }else{
            return $this->getContext()->texyPublic;
        }
    }
    private function configToService($config){
