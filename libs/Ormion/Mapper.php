...
class Mapper extends \Nette\Object implements IMapper {
   ...
   protected function loadAssociations() {
	 ...
	 if ($v[0] instanceof IAssociation) {
   ...
   public function loadValues(IRecord $record, $values = null) {
	 ...
	 throw new \Nette\InvalidStateException("Key was not set.", null, $e);
      }
    ...
    * @param IRecord record
    */
   public function insert(IRecord $record, $asReference = false) {
      try {
