 ...
 * @author     David Grudl
 *
 * @property-read Application\Request $request
...
abstract class Presenter extends Control implements Application\IPresenter
{
	...
	/**
	 * @param  Application\IResponse  optional catched exception
	 * @return void
	 */
	...
	/**
	 * @return void
	 * @throws Application\BadRequestException if no template found
	 ...
	 * @return void
	 * @throws Application\BadRequestException if action name is not valid
	 */
