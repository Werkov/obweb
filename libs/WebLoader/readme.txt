...
Presenter:
	...
	abstract class BasePresenter extends Presenter {
		...
		protected function createComponentJs() {
			...
			$js->tempUri = Environment::getVariable("baseUri") . "data/webcache";
			$js->tempPath = WWW_DIR . "/data/webcache";
		...
		protected function createComponentCss() {
			...
			$css->tempUri = Environment::getVariable("baseUri") . "data/webcache";
			$css->tempPath = WWW_DIR . "/data/webcache";
